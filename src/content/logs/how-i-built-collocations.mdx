...
The idea was also to maintain the style and components for this website. I decided to keep each site in its own repository:

- [juan.md](https://github.com/juanoa/juan.md)
- [collocations](https://github.com/juanoa/collocations)

They share the same visual direction while remaining independent to develop and deploy.
...
I used the same UI as `www.juan.md`. Both projects keep local copies of the small set of primitives they need, so each one can evolve independently. Basically, my whole design system is based on **Tailwind** and **Shadcn**, with a custom theme I generated using the [Shadcn creator mode](https://ui.shadcn.com/create).
...
/>
<p class="text-muted-foreground text-center italic">Random feature</p>
